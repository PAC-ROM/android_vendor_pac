...
1.  [Dependencies] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/dependencies/)
    ...
    - The main branch should be pac-6.0 and legacy devices that can not be brought up to Android 5.x will also not be accepted.
...
2.  [Product make files] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/products/)
...
3.  [Vendor setup] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/vendorsetup.sh)
    - Self explanatory.
    - Keep alphabetical.

4.  [Contributors] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/CONTRIBUTORS.mkdn)
    - Keep alphabetical.
    - Don't forget to change the total devices at the bottom.

5.  [Nightly] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/nightly.xml)/[Weekly] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/weekly.xml)
    - [Nightly] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/nightly.xml) - If your device qualifies (no adds/removes/extras needed) add your device here.
    - [Weekly] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/weekly.xml) - If your device uses the adds/removes/extras (mostly legacy devices) add your device here.
    - Keep alphabetical.

6.  [XDA Threads] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/docs/XDAThreads.mkdn)
    - Add your thread links here.
    - Keep it alphabetical.
    - Follow the format.

7.  [PAC Threads] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/docs/PACThreads.mkdn)
    - Add your thread links here.
    - Keep it alphabetical.
    - Follow the format.

8.  [XDA Forum Thread Template] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/docs/XDAForumThreadTemplate)
    - Just c/p to your thread.
    - Fill in the needed specific device areas.
    - PAC-ROM Downloads link should direct to PAC Forum Thread.

9.  [PAC Forum Thread Template] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/docs/PACForumThreadTemplate)
    - Just c/p to your thread.
    - Fill in the needed specific device areas.
    - Link to https://s.basketbuild.com/devs/pacman/DEVICE_CODENAME/.

10. [Devices Breakdown] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/devices-breakdown.xml)
    - Used for our dynamic changelog.
    - Keep alphabetical.

11. [Adds/Removes] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/extras/addremove/)
    - Found in the [extras/addremove] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/extras/addremove/) folder.
...
12. [Extras] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/tools/extras.sh)
    - Found in [tools] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/tools/).
    - You can add cherries, topics and queries from review page of some accounts, for more details check [Extras] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/tools/extras.sh)
    - You can save patches in the [extras/patches] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/extras/patches/) folder.
    - This injects cherry picks and patches for Gerrit and other commits.
    - If PAC hosts the repos, then please use this method by adding your patches to our repos and sending a commit to Gerrit with the patch and a DO NOT MERGE message. We will abandon the commit and you can use the [extras.sh] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/tools/extras.sh) file to cherry-pick during build.
    - Very easy to use and understand. (read the extras.sh file for detailed instructions)
    - Disqualifies your device for nightlies.

13. [Overlays] (https://github.com/PAC-ROM/android_vendor_pac/tree/pac-6.0/overlay/)
