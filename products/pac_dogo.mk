...
ifeq (pac_dogo,$(TARGET_PRODUCT))

# OVERLAY_TARGET adds overlay asset source
OVERLAY_TARGET := pa_sony-blue

# AOKP device overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pac/overlay/aokp/device/dogo
...
$(call inherit-product, device/samsung/dogo/cm.mk)

PRODUCT_NAME := pac_dogo
