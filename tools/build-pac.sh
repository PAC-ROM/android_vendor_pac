...
usage()
{
    ...
    echo -e "    -m# Maitenance version: If you do not select this option, the default will be (Dev)"
    echo -e "        1 - Nightly"
    echo -e "        2 - Stable"
...
if [ "$opt_maitenance" -eq 1 ]; then
    export PAC_VERSION_MAINTENANCE="Nightly"
elif [ "$opt_maitenance" -eq 2 ]; then
