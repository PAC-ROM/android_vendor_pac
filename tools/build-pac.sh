...
usage()
{
    ...
    echo -e "        1 (Os) or 3 (O3)"
    echo -e "    -t  Build TWRP Recovery (extreme caution, this is dangerous!) ONLY for developers"
    echo -e "        (ONLY if You must have the correct settings for TWRP in BoardConfig.mk of your device)"
